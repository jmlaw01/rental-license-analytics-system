...
/sql/ schema.sql      # Full normalized schema (tables, keys, constraints) load_data.sql   # Inserts cleaned data into the schema views.sql       # Reporting views for Power BI 
